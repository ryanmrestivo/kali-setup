...
install_oscp() {
    ...
    sudo apt install -y smbmap nikto snmp-check enum4linux-ng responder \
        evil-winrm ffuf hashcat john neo4j bloodhound
...
• Osmedeus: Offensive security engine for recon." 15 70
                ;;
            3)
                whiptail --title "OSCP Approved Suite" --msgbox "• NetExec (NXC): Successor to CrackMapExec.
...
• nmapAutomator: Comprehensive nmap automation." 15 70
                ;;
            4)
